...
class CKN_Register_Form {
    ...
    */
    ...
    <p class="ckn-form-group">
        <label for="ckn_email"><?php _e('Email', 'cool-kids-network'); ?></label>
        <input type="email" name="ckn_email" id="ckn_email" required class="ckn-input">
    </p>
    <p class="ckn-form-group">
        <button type="submit" id="ckn_register_btn" class="ckn-btn"><?php _e('Confirm', 'cool-kids-network'); ?></button>
    </p>
    ...
    */
    ...
    //     wp_enqueue_script( 'ckn-register-ajax', CKN_URL . '/assets/js/ckn-main.js', [ 'jquery' ], null, true );
    //     wp_localize_script( 'ckn-register-ajax', 'ckn_ajax', [
